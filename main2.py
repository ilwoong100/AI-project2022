...
from models.Resnet18_text import ResNet18_text
...
"""
# lenet / alexnet / resnet50 /resnet18 / resnet18_vec
model_name = 'resnet18_vec'
# cifar10 / svhn
...
def main():
    ...
    for train_idx, valid_idx in kf.split(x):
        ...
        for search_cnt in range(num_search):
            ...
            elif model_name == 'resnet18_vec':
                model = ResNet18_text(3,22, learning_rate, reg_lambda, device)    
            ...
            elif model_name == 'resnet18_text':
                os.remove('./best_model/ResNet18_text.pt')    
            cv_accuracy.append(best_acc)
            model.plot_accuracy(k)
            k+=1
        print(f'best_valid_acc: {best_acc}, best_hyper_params: {best_hyper_params} (num_epochs, learning_rate, reg_lambda, batch_size, text_vector_v1)')
